...
import me.hosairis.ptd.modules.holo.listeners.ArenaStatusChangeListener
...
class HoloModule {
    companion object {
        ...
        fun register() {
            ...
            Bukkit.getPluginManager().registerEvents(ArenaStatusChangeListener(), PunchToDeposit.getInst())
